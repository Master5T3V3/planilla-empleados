...
//Estructura, entidad de sucursal
struct Sucursal {
	int numsucursal; //Variable de numero de sucursal
	char nombresucursal[60]; //Variable de nombre de sucursal
};
...
int main (int argc, char *argv[]) { 
	...
	Sucursal s; //Ejecutar estructura sucursal
